...
<head>
    <meta charset="UTF-8">
    <title>jQuery/Ajax - Exercice 3</title>
...
<body class="container">
    <nav class="overlay" role="navigation">
        ...
        <div class="reseaux">
            <a href="https://www.instagram.com/unknown.agence/" class="instagram" title="Page instagram" target="_blank" alt="instagram" title="Page instagram" rel="noopener"></a>
            <a href="https://www.facebook.com/Unknown-agence-114879753243965" class="facebook" title="Page facebook" target="_blank" alt="facebook" title="Page facebook" rel="noopener"></a>

        </div>
    </nav>

    <div class="navbar">
        <a href=""><svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 3071.000000 3307.000000" preserveAspectRatio="xMidYMid meet">
                <g transform="translate(0.000000,3307.000000) scale(0.100000,-0.100000)" stroke="none" class="logo" fill="#ffffff">
...
-244 332 -12 8 -1996 11 -1996 3z" />
    ...
    <form action="" method="get">
        <legend>Choisissez votre sportif</legend>
	...
	?>
            ...
            <a href="affiche_sportif.php"><input type="submit" value="Filtrer"></a>
        </div>
    </form>

    <div id="page">
        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Deserunt magni neque, minus sint nulla dolore voluptatem dolorum repudiandae blanditiis cumque rem, aliquid quos corrupti reprehenderit obcaecati exercitationem non porro mollitia. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ducimus facilis a sint earum! Ipsam iusto vitae assumenda beatae! Necessitatibus veritatis magnam nobis aspernatur voluptas, in ea asperiores nostrum modi! Atque? Lorem ipsum dolor sit amet, consectetur adipisicing elit. Temporibus deserunt ratione corrupti cum vitae aut quasi officiis, esse nemo modi? Suscipit expedita debitis alias necessitatibus eveniet, obcaecati iusto et incidunt!</p>
    </div>

    <!-- Commencez à coder à partir de cette zone : -->
    <!-- ============================================================================================= -->
    ...
    <script>
        (function() {
            ...
            /*
              Votre code JS ici ...
              - Écoutez les évènements 'click' sur les liens du menu
              - Lors d'un clic sur le lien, stoppez l'action par défaut du navigateur et récupérez dans une variable le nom de la page .html ciblée
              - A l'aide de la méthode .load() de jQuery, lancez une requête Ajax pour aller chercher cette page dans le dossier /pages/, et insérez le tout dans la <div id="page">
              
              (N'oubliez pas d'inclure la bibliothèque jQuery dans le HTML, ni le document ready)
              (N'oubliez pas non plus de lancer cette page via un serveur HTTP)
            */
